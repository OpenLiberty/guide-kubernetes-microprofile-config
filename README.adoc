...
In the [hotspot=env1 hotspot=env2 file=0]`env` section under the
[hotspot=system-container file=0]`system-container` and the
[hotspot=inventory-container file=0]`inventory-container, the
[hotspot=contextRoot1 hotspot=contextRoot2 file=0]`CONTEXT_ROOT`,
...
The [hotspot=valueFrom1 hotspot=valueFrom2 hotspot=valueFrom3 hotspot=valueFrom4
hotspot=valueFrom5 hotspot=valueFrom6 file=0]`valueFrom` field allows you to
...
value [hotspot=contextRoot1 hotspot=contextRoot2 file=0]`contextRoot` from the
ConfigMap [hotspot=root1 hotspot=root2 file=0]`sys-app-root`. Similarly,
...
from the Secret [hotspot=credentials1 hotspot=credentials2 hotspot=credentials3
hotspot=credentials4 file=0]`sys-app-credentials`.
