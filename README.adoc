...
== View and Update ConfigMaps and Secret
...
You can quickly modify ConfigMaps by running the following command. This creates a new ConfigMaps and completely replaces the old one.
...
You will see that the app name has changed from `system` to `new-name`.
