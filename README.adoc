...
----
The [hotspot=16-18]`greeting` member was added to the return value of [hotspot=26-28]`getContainerName()`.
...
The `env` sections under the `ping-container` is where the `USERNAME` and `PASSWORD` environment variables were be set.
