...
----
Replace the `NameResource` class file.
...
[role="code_command hotspot=1-78", subs="quotes"]
----
Replace the `PingResource` class file.
...
[role="code_command hotspot=1-88", subs="quotes"]
----
