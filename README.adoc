...
:page-seo-title: Configuring Java microservices on Kubernetes with MicroProfile Config 
:page-seo-description: A getting started tutorial with examples of how to externalize configuration with MicroProfile Config and use Kubernetes ConfigMaps and Secrets to configure your Java microservices.
